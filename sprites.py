...
class Spritesheet(object):
    def __init__(self):
        ...
        transparent_color = self.sheet.set_colorkey((255, 0, 255))
    ...
    def getImage(self, x, y, width, height):
        ...
        image = self.sheet.subsurface(self.sheet.get_clip()).copy()
        image.set_colorkey((255, 0, 255))
        return image
    
class PacmanSprites(Spritesheet):
    def __init__(self, entity, animSpeed = 20):
    ...
    def defineAnimations(self):
        self.animations[LEFT] = Animator(((8,0), (0,0), (0,2), (0,0)), speed = self.animSpeed)
        self.animations[RIGHT] = Animator(((10,0), (2,0), (2,2), (2,0)), speed = self.animSpeed)
        self.animations[UP] = Animator(((10,2), (6,0), (6,2), (6,0)), speed = self.animSpeed)
        self.animations[DOWN] = Animator(((8,2), (4,0), (4,2), (4,0)), speed = self.animSpeed)
...
class MazeSprites(Spritesheet):
    ...
    def getImage(self, x, y):
        return super().getImage(x, y, TILE_WIDTH, TILE_HEIGHT)
    ...
    def rotate(self, sprite, value):
        rotated = pygame.transform.rotate(sprite, value * 90)
        rotated.set_colorkey((255,0,255)) # setting background color back to magenta after rotation for transparency
        return rotated
